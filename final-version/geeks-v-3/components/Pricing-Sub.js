...
<section id="pricing" className="py-12">
      <div className="max-w-xl px-4 py-12 mx-auto sm:px-6 lg:max-w-6xl lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="p-5 mt-5 mb-10 space-y-6 border shadow-md rounded-2xl bg-sky-950">
          ...
          <div className="p-5 mb-10 space-y-6 border-2 dark:border-rose-300 rounded-2xl bg-sky-950">
            <h1 className="text-xl font-bold text-center text-teal-600 dark:text-teal-300 md:text-2xl sm:text-left">
            Premium 
            </h1>
